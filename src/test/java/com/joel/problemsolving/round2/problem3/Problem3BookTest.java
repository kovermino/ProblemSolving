...
class Problem3BookTest {

    private Problem3Book sut = new Problem3Book();

    @ParameterizedTest
    @MethodSource(value = "permutations")
    void isPermutationVersion1_서로_순열인_문자열을_입력받으면_true를_리턴한다(String[] permutationPair) {
        String first = permutationPair[0];
        String second = permutationPair[1];


        assertTrue(sut.isPermutationVersion1(first, second));
    }

    @ParameterizedTest
    @MethodSource(value = "notPermutations")
    void isPermutationVersion1_순열이_아닌_문자열을_입력받으면_false를_리턴한다(String[] notPermutationPair) {
        String first = notPermutationPair[0];
        String second = notPermutationPair[1];


        assertFalse(sut.isPermutationVersion1(first, second));
    }

    @ParameterizedTest
    @MethodSource(value = "includeNulls")
    void isPermutationVersion1_null이_입력되면_false를_리턴한다(String[] nullPair) {
    ...
    void isPermutationVersion1_빈_문자열이_입력되면_false를_리턴한다(String[] emptyPair) {
    ...
    @ParameterizedTest
    @MethodSource(value = "permutations")
    void isPermutationVersion2_서로_순열인_문자열을_입력받으면_true를_리턴한다(String[] permutationPair) {
        String first = permutationPair[0];
        String second = permutationPair[1];


        assertTrue(sut.isPermutationVersion2(first, second));
    }

    @ParameterizedTest
    @MethodSource(value = "notPermutations")
    void isPermutationVersion2_순열이_아닌_문자열을_입력받으면_false를_리턴한다(String[] notPermutationPair) {
        String first = notPermutationPair[0];
        String second = notPermutationPair[1];


        assertFalse(sut.isPermutationVersion2(first, second));
    }

    @ParameterizedTest
    @MethodSource(value = "includeNulls")
    void isPermutationVersion2_null이_입력되면_false를_리턴한다(String[] nullPair) {
        String first = nullPair[0];
        String second = nullPair[1];
    ...
    @ParameterizedTest
    @MethodSource(value = "includeEmptyStrings")
    void isPermutationVersion2_빈_문자열이_입력되면_false를_리턴한다(String[] emptyPair) {
        String first = emptyPair[0];
        String second = emptyPair[1];
