...
class Problem1Test {
    @Test
    void findFirstInCircularLinkedList_순환고리의_첫번째_노드를_리턴한다() {
    ...
    @Test
    void findFirstInCircularLinkedList_순환고리의_첫번째_노드가_root인_경우에는_root를_리턴한다() {
        Node root = new Node(null, 0);
        Node node1 = new Node(null, 1);
        Node node2 = new Node(null, 2);
        Node node3 = new Node(null, 3);
    ...
    @Test
    void findFirstInCircularLinkedList_순환고리가_없는_경우에는_null을_리턴한다() {
        Node root = new Node(null, 0);
        Node node1 = new Node(null, 1);
        Node node2 = new Node(null, 2);
        Node node3 = new Node(null, 3);
    ...
    @Test
    void findFirstInCircularLinkedList_null을_입력받으면_null을_리턴한다() {
        Problem1 sut = new Problem1();
